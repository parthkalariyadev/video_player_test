        ...
        companion object {
            ...
            fun fromMap(@NonNull map: Map<String?, Any?>): TextureMessage {
                ...
                pigeonResult.setTextureId(
                    (if (textureId == null) null else if (textureId is Int) textureId else textureId as Long?) as Long?
                )
                return pigeonResult
            }
        }
        ...
        companion object {
            ...
            fun fromMap(@NonNull map: Map<String?, Any?>): PositionMessage {
                ...
                pigeonResult.setPosition(
                    (if (position == null) null else if (position is Int) position else position as Long?) as Long?
                )
                return pigeonResult
            }
        }
